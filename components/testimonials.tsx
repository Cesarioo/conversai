...
const testimonials: Testimonial[] = [
    {
        ...
        company: "TechCorp",
        content:
            "ConversAI has transformed our customer support. Our response times have decreased by 80%, and customer satisfaction has soared.",
    ...
    },
    {
        ...
        content:
            "The natural language processing capabilities of ConversAI are impressive. It's like having a team of expert support agents available 24/7.",
        image: "https://cdn.prod.website-files.com/659ee966a09539fc16cb266a/65b168c3467da455a5bbce97_business-woman-restaurant-owner-use-laptop-in-hand-2022-09-29-20-58-33-utc.webp",
    ...
    },
    {
        ...
        content:
            "Implementing ConversAI was seamless. The ROI we've seen in just a few months is remarkable. It's a game-changer for our business.",
...
export function Testimonials() {
    ...
    const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => (
        <div className="relative overflow-hidden rounded-xl shadow-lg aspect-[4/3]">
            <div
                className={`absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t ${testimonial.gradient} z-10`}
            />
            <img
