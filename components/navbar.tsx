...
const navigationItems: NavigationItem[] = [
  {
    ...
    items: [
      ...
      },
      {
        icon: ShoppingBag,
        title: "E-commerce",
        description: "Provide 24/7 customer support for online shoppers",
        href: "#ecommerce",
      },
      {
        icon: Stethoscope,
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-8">
            <Link href="/" className="flex items-center space-x-2">
              <span className="text-2xl font-bold text-primary">VoiceAI</span>
            </Link>
              ...
              {navigationItems.map((item) => (
                ...
                >
                  {item.items ? (
                    ...
                    <Link href={item.href} className="text-foreground/80 hover:text-foreground transition-colors py-2">
                      {item.title}
                    </Link>
                  ) : null}
                  ...
                  {/* Dropdown Menu */}
                  <AnimatePresence>
                    {item.items && hoveredSection === item.title && (
                      <motion.div
