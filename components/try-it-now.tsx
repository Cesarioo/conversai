          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                Experience AI-Powered Support <span className="text-secondary">Now</span>
              </h2>
              <p className="text-xl mb-8 text-primary-foreground/80">
                Transform your customer support instantly with our cutting-edge AI voice agent.
              </p>
              <ul className="space-y-4 mb-8">
                {["24/7 Availability", "Instant Response", "Personalized Interactions"].map((feature, index) => (
                  <motion.li
                    key={index}
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                <h3 className="text-2xl font-semibold mb-4">Get a Free Demo Call</h3>
                ...
                >
                  {submitted ? <CheckCircle className="mr-2" /> : <PhoneCall className="mr-2" />}
                  {submitted ? "Demo Call Scheduled!" : "Schedule Your Demo"}
                </Button>
              </form>
              <p className="mt-6 text-sm text-center text-primary-foreground/70">
                Experience the future of customer support. No obligation, just pure innovation.
              </p>
            </motion.div>
          </div>
        </div>
